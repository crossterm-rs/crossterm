...
impl From<MOUSE_EVENT_RECORD> for MouseEvent {
    fn from(event: MOUSE_EVENT_RECORD) -> Self {
        MouseEvent {
            ...
            control_key_state: ControlKeyState::from(event.dwControlKeyState),
...
impl From<DWORD> for ButtonState {
    fn from(event: DWORD) -> Self {
        match event {
            ...
            _ => panic!("Button state {} does not exist.", event),
        }
    }
}
...
impl From<DWORD> for ControlKeyState {
    fn from(event: DWORD) -> Self {
        match event {
            0x0080 => ControlKeyState::CapsLockOn,
            0x0100 => ControlKeyState::EnhancedKey,
            0x0002 => ControlKeyState::LeftAltPressed,
            0x0008 => ControlKeyState::LeftCtrlPressed,
            0x0020 => ControlKeyState::NumLockOn,
            0x0001 => ControlKeyState::RightAltPressed,
            0x0004 => ControlKeyState::RightCtrlPressed,
            0x0040 => ControlKeyState::ScrollLockOn,
            0x0010 => ControlKeyState::ShiftPressed,
            _ => panic!("Control key state {} does not exist.", event),
        }
    }
}
